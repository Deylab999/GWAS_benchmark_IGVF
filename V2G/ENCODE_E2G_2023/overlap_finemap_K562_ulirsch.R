...
finemap1 = read.table("/data/deyk/kushal/ENCODE_E2G_GWAS_benchmark/data/GWAS_traits/Other_finemapped/FINEMAP_Ulirsch_ALL_RBC_10")[,1]
finemap2 = read.table("/data/deyk/kushal/ENCODE_E2G_GWAS_benchmark/data/GWAS_traits/Other_finemapped/FINEMAP_Ulirsch_ALL_RBC_50")[,1]
finemap3 = read.table("/data/deyk/kushal/ENCODE_E2G_GWAS_benchmark/data/GWAS_traits/Other_finemapped/FINEMAP_Ulirsch_ALL_MCH_10")[,1]
finemap4 = read.table("/data/deyk/kushal/ENCODE_E2G_GWAS_benchmark/data/GWAS_traits/Other_finemapped/FINEMAP_Ulirsch_ALL_MCH_50")[,1]
finemap5 = read.table("/data/deyk/kushal/ENCODE_E2G_GWAS_benchmark/data/GWAS_traits/Other_finemapped/FINEMAP_Ulirsch_ALL_MCV_10")[,1]
finemap6 = read.table("/data/deyk/kushal/ENCODE_E2G_GWAS_benchmark/data/GWAS_traits/Other_finemapped/FINEMAP_Ulirsch_ALL_MCV_50")[,1]
finemap7= read.table("/data/deyk/kushal/ENCODE_E2G_GWAS_benchmark/data/GWAS_traits/Other_finemapped/FINEMAP_Ulirsch_ALL_Hb_10")[,1]
finemap8 = read.table("/data/deyk/kushal/ENCODE_E2G_GWAS_benchmark/data/GWAS_traits/Other_finemapped/FINEMAP_Ulirsch_ALL_Hb_50")[,1]
finemap9= read.table("/data/deyk/kushal/ENCODE_E2G_GWAS_benchmark/data/GWAS_traits/Other_finemapped/FINEMAP_Ulirsch_ALL_HbA1c_10")[,1]
finemap10 = read.table("/data/deyk/kushal/ENCODE_E2G_GWAS_benchmark/data/GWAS_traits/Other_finemapped/FINEMAP_Ulirsch_ALL_HbA1c_50")[,1]
finemap11= read.table("/data/deyk/kushal/ENCODE_E2G_GWAS_benchmark/data/GWAS_traits/Other_finemapped/FINEMAP_Omer_blood_RBC_DISTRIB_WIDTH_10")[,1]
finemap12 = read.table("/data/deyk/kushal/ENCODE_E2G_GWAS_benchmark/data/GWAS_traits/Other_finemapped/FINEMAP_Omer_blood_RBC_DISTRIB_WIDTH_50")[,1]

...
finemap1 = read.table("/n/groups/price/kushal/ENCODE/data/GWAS_traits/Other_finemapped/FINEMAP_Ulirsch_ALL_Lym_10")[,1]
finemap2 = read.table("/n/groups/price/kushal/ENCODE/data/GWAS_traits/Other_finemapped/FINEMAP_Ulirsch_ALL_Lym_50")[,1]
finemap3 = read.table("/n/groups/price/kushal/ENCODE/data/GWAS_traits/Other_finemapped/FINEMAP_Ulirsch_ALL_Mono_10")[,1]
finemap4 = read.table("/n/groups/price/kushal/ENCODE/data/GWAS_traits/Other_finemapped/FINEMAP_Ulirsch_ALL_Mono_50")[,1]
finemap5 = read.table("/n/groups/price/kushal/ENCODE/data/GWAS_traits/Other_finemapped/FINEMAP_Ulirsch_ALL_RBC_10")[,1]
finemap6 = read.table("/n/groups/price/kushal/ENCODE/data/GWAS_traits/Other_finemapped/FINEMAP_Ulirsch_ALL_RBC_50")[,1]
finemap7 = read.table("/n/groups/price/kushal/ENCODE/data/GWAS_traits/Other_finemapped/FINEMAP_Ulirsch_Noncoding_Lym_10")[,1]
finemap8 = read.table("/n/groups/price/kushal/ENCODE/data/GWAS_traits/Other_finemapped/FINEMAP_Ulirsch_Noncoding_Lym_50")[,1]
finemap9 = read.table("/n/groups/price/kushal/ENCODE/data/GWAS_traits/Other_finemapped/FINEMAP_Ulirsch_Noncoding_Mono_10")[,1]
finemap10 = read.table("/n/groups/price/kushal/ENCODE/data/GWAS_traits/Other_finemapped/FINEMAP_Ulirsch_Noncoding_Mono_50")[,1]
finemap11 = read.table("/n/groups/price/kushal/ENCODE/data/GWAS_traits/Other_finemapped/FINEMAP_Ulirsch_Noncoding_RBC_10")[,1]
finemap12 = read.table("/n/groups/price/kushal/ENCODE/data/GWAS_traits/Other_finemapped/FINEMAP_Ulirsch_Noncoding_RBC_50")[,1]
...
rownames(outdf) = c("Ulirsch_ALL_Lym_10", "Ulirsch_ALL_Lym_50",
                    "Ulirsch_ALL_Mono_10", "Ulirsch_ALL_Mono_50",
                    "Ulirsch_ALL_RBC_10", "Ulirsch_ALL_RBC_50",
                    "Ulirsch_Noncoding_Lym_10", "Ulirsch_Noncoding_Lym_50",
                    "Ulirsch_Noncoding_Mono_10", "Ulirsch_Noncoding_Mono_50",
		    				                 "Ulirsch_Noncoding_RBC_10", "Ulirsch_Noncoding_RBC_50")
